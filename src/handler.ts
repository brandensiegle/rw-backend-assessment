...
/**
 *
 * Using the (Streaming Availability API)[https://docs.movieofthenight.com/resource/shows], return to me a list
 * of movies to watch and the streaming service they’re on. Group them by the service and order them in
